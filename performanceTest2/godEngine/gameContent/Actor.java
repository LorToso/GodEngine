...
public abstract class Actor 
{
	...
	public void setLocation(double dx, double dy)
	{
		...
		if(world != null)
		{
			...
			getWorld().recalculateOccupiedPixelMovement(this, (int)dx, (int)dy);
		}
	...
	public int getWidth() {
		return getImage().getWidth()/getWorld().getCellSize();
	}
	public int getHeight() {
		return getImage().getHeight()/getWorld().getCellSize();
	}
